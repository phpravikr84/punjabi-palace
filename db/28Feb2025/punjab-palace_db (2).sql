...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2025 at 07:53 AM
...
(1, '<p>Level 2, Crown Hotel, Port Moresby,</p>\r\n<p>Papua New Guinea</p>', 'accounts@adzguru.co', '8582957232', '+91 8582957232', 'assets/img/2025-02-11/P.png', 'assets/img/2025-02-11/P1.png', 1, 'Developed with ❤️ by Adzguru (PNG) Limited\r\n', 1, NULL, NULL, NULL, NULL);
...
(1, 'Maida', 1, '-1.50', '2.00', 0, 1),
(2, 'Refined Oil', 2, '15.70', '2.00', 0, 1),
...
(2, 'John', 'Doe', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum', '', 'admin@example.com', '827ccb0eea8a706c4c34a16891f84e7b', '', './assets/img/user/m2.png', '2025-02-28 15:11:55', '2025-02-19 15:10:55', '::1', NULL, 1, 1),
...
--
ALTER TABLE `accesslog`
  MODIFY `sl_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=423;
...
--
ALTER TABLE `bill`
  MODIFY `bill_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `itxn`
  MODIFY `tid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
ALTER TABLE `order_menu`
  MODIFY `row_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `variant`
  MODIFY `variantid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
