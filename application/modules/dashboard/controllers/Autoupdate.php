...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.adzguru.co/punjabi_palace/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.adzguru.co/punjabi_palace/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.adzguru.co/punjabi_palace/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.adzguru.co/punjabi_palace/autoupdate/update_info');
// CRM temporary path
