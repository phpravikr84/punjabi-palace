...
<head>
    ...
    <style>
        ...
        .btn-login {
            ...
            text-transform: uppercase;
            width: 100%;
            /* Center and make button full width */
            max-width: 250px;
            display: block;
            text-align: center;
            margin: 10px auto;
...
<body>
            ...
            <div class="login-content login-content_bg p-4">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="<?php echo display('email') ?>" placeholder="<?php echo display('email') ?>" name="email" id="email" autocomplete="off" style="padding-left: 0px !important;" />
                    </div>
                </div>
    ...
    <!-- <div class="login vh100 d-flex align-items-center justify-content-center" style="display: none;">
    </div> -->
