    ...
    <div class="sidebar-link">
        <span class="top-fixed-link">
            <?php 
                ...
                <a href="<?php echo base_url("ordermanage/order/pos_invoice") ?>" class="btn custom_btn_in_header text-green"><i class="fa fa-plus text-green"></i> <?php echo 'POS Frontend' ?></a>
