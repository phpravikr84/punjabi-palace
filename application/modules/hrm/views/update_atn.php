        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="date" class="form-control" type="hidden" id="date"
                            value="<?php echo $data->date ?>" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="sign_in" class=" form-control" type="hidden"
                            value="<?php echo $sign_in = $data->sign_in ?>" id="sign_in" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="hidden" name="sign_out" class="form-control" id="adv_details"
                            value="<?php
                ...
                <center class="update-atn-css1"><i class="fa fa-clock-o" aria-hidden="true"></i></center>

                <div class="form-group text-center">
                    <a href="<?php echo base_url('hrm/Home/index') ?>" class="btn btn-danger">
