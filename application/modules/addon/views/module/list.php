                ...
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                            ...
                            <?php echo form_open_multipart("addon/module/upload/") ?>
                                <div class="col-sm-3">
                                    <label><?php echo display('purchase_key') ?> <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Envato purchase key or adzguru purchase key"></span></label>
                                            ...
                                            <div class="thumbnail">
                                              ...
                                              <div class="caption">
                                                ...
                                                <p>
                                                    ...
                                                    <?php if(isset($HmvcConfig[$mod]['_zip_download']) && !empty($HmvcConfig[$mod]['_zip_download'])){?>
													...
													?>
													<a onclick="return confirm('<?php echo display("are_you_sure") ?>')"  class="btn btn-success" href="<?php echo base_url($mod.'/androidpos/app_download?module='.$mod.'&downloadurl=https://play.google.com/store/apps/details?id=com.punjabi_palace') ?>" target="_new"><?php echo display("download") ?></a>
													<?php } } else { ?>
