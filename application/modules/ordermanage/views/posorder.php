    ...
    <div class="panel-body">
      <div class="tabsection"> <span class="display-none"><?php echo $settinginfo->language; ?></span>
        <ul class="nav nav-tabs" role="tablist">
          <!-- <li><?php //print_r($this->session->all_userdata()); ?></li> -->
          ...
          <!-- <li><a href="<?php //echo base_url() ?>ordermanage/order/alltables" class="maindashboard"><i class="fa fa-table"></i> <?php //echo 'All tables'; ?></a></li> -->
           <li><a href="javascript:void()" onclick="openTablePage()"class="maindashboard"><i class="fa fa-table"></i> <?php echo 'All tables'; ?></a></li>
          <?php } ?>
...
function openTablePage() {
    ...
    // Build new URL with whatever params exist
    const newUrl = window.location.origin + "/ordermanage/order/alltables/1?" + urlParams.toString();
