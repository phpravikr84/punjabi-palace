                                ...
                                <div class="col-sm-12 d-flex justify-content-end">
                                    <?php if ($orderinfo->splitpay_status == 0) { ?>
                                        ...
                                        <?php if ($this->permission->method('ordermanage', 'delete')->access()) { ?>
                                            <a href="javascript:;" data-id="<?php echo $orderinfo->order_id;?>" class="btn btn-md btn-warning footer-btn mr-1 cancelorder" data-toggle="tooltip" data-placement="top" title="<?php echo display('cancel_order'); ?>">
                                                <i class="fa fa-trash-o"></i>
                                            </a>
                                        <?php } ?>
                                        <a href="javascript:;" class="btn btn-danger cusbtn mr-1 due_print" data-toggle="tooltip" data-placement="top" title="<?php echo display('due_invoice'); ?>" data-url="<?php echo base_url("ordermanage/order/dueinvoice/".$orderinfo->order_id); ?>">
                                           Invoice
                                        </a>
                                    <?php } else { ?>
                                        <a href="javascript:;" onclick="showsplitmodal(<?php echo $orderinfo->order_id;?>)" class="btn btn-warning btn-large cusbtn" data-toggle="tooltip" data-placement="top" title="<?php echo display('split'); ?>">
                                            <?php echo display('split'); ?>
                                        </a>
                                    <?php } ?>
