            ...
            <div class="row">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <table class="table table-fixed table-bordered table-hover bg-white wpr_100 dfsgsfsfgsgfsfg">
                                <tr>
                                    <td>
                            ...
                            <div class="form-group text-right mt-3">
                                <div class="col-sm-12 mt-15 pr-0">
                                    ...
                                    ?>
                                        ...
                                        <?php } ?>
                                        <button type="button" id="paidbill" class="btn btn-success w-md m-b-5 <?php if ($duemerge == 1) {
                                                                                                                    echo "col-sm-12";
                                                                                                                } else {
                                                                                                                    echo "col-sm-6";
                                    ...
                                    <?php } else {
                                    ?>
                                        <button type="button" class="btn btn-success w-md m-b-5 sdfgfs" id="pay_bill" onfocus="submitmultiplepay()"><?php echo display('pay_print'); ?></button>
