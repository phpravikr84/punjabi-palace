...
.login-wrapper {
    background: url(../img/punjabi_palace/login-bg.jpg) no-repeat;
...
.food_item:focus .punjabi_palace_title,
.food_item:hover .punjabi_palace_title {
    color: #fff;
}
           ...
           <?php $i++;} }}?>
			...
			?>
                ...
                <div class="row-data">
					...
					if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $changes; ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <div class="row-data">
                    <div class="item-info">
