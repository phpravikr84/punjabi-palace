	                    ...
	                    <div class="panel-body">
	                        ...
	                        <div class="table-responsive m-b-20">
								  ...
								  $totalamount=0;
									...
									if(count($orderedMods)>0){
									  ...
									  <tr>
										...
										<td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $mv->price*1;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
									</tr>
									  <?php
										  }
										}
									...
									if(count($selectedFoodsForCart)>0){
									  ...
									  <tr>
										...
										<td class="text-right"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo 0;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </td>
										<td class="text-right"><?php echo 1;?></td>
										<td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo 0*1;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
									</tr>
									  <?php
										  }
										}
                                    ...
                                    <tr>
                                    	...
                                    	<td class="text-right" colspan="4"><strong>GST/TAX (<?php echo $settinginfo->vat;?>%)</strong></td>
								...
								foreach($taxinfos as $mvat){
										...
										?>
                                    <tr>
                                    	<td class="text-right" colspan="4"><strong><?php echo $mvat['tax_name'];?></strong></td>
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $taxinfo->$fieldname;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
                                     <?php $i++;} }}?>
                                    <tr>
                                    	<td class="text-right" colspan="4"><strong><?php echo display('grand_total')?></strong></td>
                                        <td class="text-right"><strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo $billinfo->bill_amount;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong></td>
                                    </tr>
