                                    ...
                                    <div class="col-sm-4 col-md-3 col-xs-6 col-xlg-2">
                                      ...
                                      <div class="hero-widget well well-sm height-auto">
                                        <div class="mdjc">
                                          ...
                                          <?php if($this->permission->method('ordermanage','update')->access() && $onprocess->splitpay_status ==0):?>
                                          <div class="display-flex align-items-center">
                                          <div class=""><a href="javascript:;" onclick="editposorder(<?php echo $onprocess->order_id;?>,1)" class="btn btn-xs btn-success btn-sm mr-1 pdmr" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display('update_ord')?>" id="table-<?php echo $onprocess->order_id;?>"><i class="fa fa-pencil"></i></a></div>
                                        ...
                                        <p class="m-0">
                                         ...
                                         <?php 
                                          ...
                                          <a href="javascript:void(0);" onclick="createMargeorder(<?php echo $onprocess->order_id;?>,1)" class="btn btn-xs btn-success btn-sm mr-1"><?php echo display('cmplt');?></a>
                                           <a href="javascript:void(0);" onclick="showsplitmodal(<?php echo $onprocess->order_id;?>)" class="btn btn-xs btn-success btn-sm mr-1"><?php echo display('split');?></a>
                                            ...
                                            <a href="javascript:;" data-id="<?php echo $onprocess->order_id;?>" class="btn btn-xs btn-danger btn-sm mr-1 cancelorder" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display('cancel_order')?>"><i class="fa fa-trash-o"></i></a>&nbsp;
                                            <?php }?>
                                            <a href="javascript:;" onclick="createMargeorder(<?php echo $onprocess->order_id;?>,1)" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display('pos_invoice') ?>"><i class="fa fa-window-maximize"></i></a>&nbsp;<a href="javascript:;" class="btn btn-xs btn-success btn-sm mr-1 due_print" data-toggle="tooltip" data-placement="left" title="" data-url="<?php echo base_url("ordermanage/order/dueinvoice/".$onprocess->order_id) ?>" data-original-title="<?php echo display('due_invoice'); ?>"><i class="fa fa-window-restore"></i></a>
                                            <?php }
                                            else{ ?>
