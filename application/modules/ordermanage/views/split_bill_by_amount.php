        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    echo form_dropdown('number', $list, $selected, 'class="form-control" id="number-of-split" onchange="showSplitByAmount(this)" data-url="' . base_url() . 'ordermanage/order/create_split_by_amount/" data-value="' . $order_info->order_id . '"');
                    ?>
                </div>
