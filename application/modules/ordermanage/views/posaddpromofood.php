      ...
      <!-- <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 text-end" style="text-align: end;padding-top: 30px;" id="modifierChoosebtnDiv">
                <button class="btn btn-success modifierChoosebtn" onclick="ApplyPromoFoodAndModifierSelect(<?=$pid;?>);">Apply</button>
            </div>
        </div>
      </div>
      <?php
...
<div id="promomainfoodlist" style="display: none;">
<?php 
      if (count($mainCats)>0):
      ?>
                          ...
                          <tbody>
                            ...
                            $pm_flist = $pmf->result();
                              ...
                              <tr>
                                  ...
                                  <td style="width: 5%;" class="text-center">
                                      <div class="form-check">
                                          <input class="form-check-input modifier-checkbox" type="checkbox" <?=$checked;?> name="promo_main_food_items[]" value="<?=$miv->id;?>" id="promo_main_food_items_<?=$miv->id;?>" data-group-id="<?=$mcv->category_id;?>" data-variantid="<?=$miv->variantid;?>" data-pid="<?=$pid;?>" autocomplete="off">
                                      </div>
                                  </td>
                              </tr>
                              <?php 
