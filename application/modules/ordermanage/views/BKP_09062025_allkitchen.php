                                    ...
                                    <div class="food_select" id="acceptitem<?php echo $orderinfo->order_id.$orderinfo->kitchenid;?>">
                                        ...
                                        <div class="align-center justify-between">
                                            ...
                                            <div class="<?php if($isaccept==0){ echo "display-block"; }else{ echo "display-none";}?>" id="isongoing<?php echo $orderinfo->order_id;?><?php echo $orderinfo->kitchenid;?>">
                                                <button class="btn btn-success w-smd lh-30" onclick="orderaccept(<?php echo $orderinfo->order_id;?>,<?php echo $orderinfo->kitchenid;?>)"><?php echo 'Confirm' ?></button>
                                                <button class="btn btn-danger w-smd lh-30" onclick="ordercancel(<?php echo $orderinfo->order_id;?>,<?php echo $orderinfo->kitchenid;?>)"><?php echo 'Pick Up' ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
