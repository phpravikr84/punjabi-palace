...
function getAjaxModalNew(
  url,
  callback = false,
  ajaxclass = "#tablebookview",
  modalclass = "#tablebookviewmodal",
  data = "",
  method = "get"
) {
  var csrf = $("#csrfhashresarvation").val();
...
function getAjaxModalPopUp(
  url,
  callback = false,
  ajaxclass = "#modal-ajaxviewnew",
  modalclass = "#tablemodalNew",
  data = "",
  method = "get"
) {
  var csrf = $("#csrfhashresarvation").val();
...
function getReservationAjaxModal(
  url,
  callback = false,
  ajaxclass = "#tablereservationview",
  modalclass = "#tablereservationviewmodal",
  data = "",
  method = "get"
) {
  var csrf = $("#csrfhashresarvation").val();
