            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-group row">
                            <!-- <label for="vat" class="col-sm-5 col-form-label"><?php ##echo display('vat') 
                                                                                    ?> <a class="cattooltips" data-toggle="tooltip" data-placement="top" title="Vat Are always Caltulate percent like: 5 means 5%;"><i class="fa fa-question-circle" aria-hidden="true"></i></a></label> -->
