                                    ...
                                    <tr>
                                        <td class="span3 supplier">
                                            ...
                                            ##if(!empty($caregory->sub)){
                                                ##foreach($caregory->sub as $subcat){
                                            ?>
                                                <option value="<?php ##echo $subcat->CategoryID;?>" disabled data-parentID="<?php ##echo $caregory->CategoryID;?>" <?php ##if($productinfo->CategoryID==$subcat->CategoryID){echo "selected";}?>>&nbsp;&nbsp;&nbsp;&mdash;<?php ##echo $subcat->Name;?></option>
                                            <?php 
                                                // if(!empty($caregory->sub->sub)){
                                                //     foreach($caregory->sub->sub as $ssubcat){
                                                //         echo $ssubcat->Name;
                                            ?>
                                                    <option value="<?php ##echo $ssubcat->CategoryID;?>" disabled data-parentID="<?php ##echo $caregory->CategoryID;?>" <?php ##if($productinfo->CategoryID==$ssubcat->CategoryID){echo "selected";}?>>&nbsp;&nbsp;&nbsp;&mdash;<?php ##echo $ssubcat->Name;?></option>
                                            <?php ##} } } } } ?>
