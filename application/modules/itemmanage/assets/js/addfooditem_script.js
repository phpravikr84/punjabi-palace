 "use strict";
  ...
  $(document).ready(function(){
    ...
    const isChecked = $('#is_bom').is(':checked');
    const value = isChecked ? 1 : 0;
    $('input[name="is_bom"][type="hidden"]').val(isChecked ? 0 : 1); // Set hidden field value based on checkbox state
    ...
    $('#is_bom').on('change', function() {
      ...
      $('input[name="is_bom"][type="hidden"]').val(isChecked ? 0 : 1);
