            ...
            <div class="content-wrapper">
                <div class="container"> 
                                ...
                                <div class="outer-container">
                                    <div class="box-inner">
                                        ...
                                        <div class="text-right">
                                            <a href="<?php echo base_url()?>login" class="btn btn-success btn-right">Launch Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <footer class="footer text-center">
                        <div class="container">
                            <div class="fText">Developed by <a target="_blank" href="https://www.adzguru.co/">adzguru</a></div>
                        </div>
                    </footer>
                    <!-- /.End of footer -->
                </div> 
