...
<input type='hidden' name='x_receipt_link_url' value='<?php echo base_url();?>frontend/successful2qr/<?php echo $page;?>' /> 
<input type='hidden' name='li_0_price' value='<?php echo $grandtotal;?>' />
