        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12" id="mycartlist">
                    <h6 class="cart_heading"><?php echo display('upsumlist') ?></h6>
                    <?php $totalqty=0;
if(!empty($this->cart->contents())){ $totalqty= count($this->cart->contents());} ;?>
            ...
            <input name="orggrandTotal" id="orggrandTotal" type="hidden" value="0" />
            <?php } 
            else{
            ?>
            <input name="vat" id="vat" type="hidden" value="<?php echo $calvat;?>" />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="check_order">
                        <div class="fixed_area only-sm update updatecart_padding_0">
<div class="container-fluid">
<div class="row">
<div class="col-12">
<div class="d-flex align-items-center justify-content-between">
<input class="btn btn-success btn-block updatecart_border_none" name="" type="submit" value="<?php echo display('update_ord') ?>" />
</div>
</div>
</div>
</div>
             ...
             <div class="row">
                <div class="col-12">
                    <div class="check_order updatecart_padding_botom">
                        <?php if($billinfo->payment_method_id!=4){?>
                        <h6 class="my-3"><?php echo display('mkpayment') ?></h6>
                        ...
                        <div class="fixed_area only-sm updatecart_padding_0" >
<div class="container-fluid">
<div class="row">
<div class="col-12">
<div class="d-flex align-items-center justify-content-between">
