                    ...
                    <table class="table">
                        ...
                        <div class="payment-block" id="payment">
                           ...
                           <?php } 
										...
										?>
										<div class="payment-item">
                                            <input type="radio" name="card_type" id="payment_method_cre<?php echo $payment->payment_method_id; ?>" data-parent="#payment" data-target="#description_cre" value="<?php echo $payment->payment_method_id; ?>" class="" <?php if ($payment->payment_method_id == $pvalue) {
                                                                                                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                                                                                                } ?>>
