...
<head>
	...
	<meta name="p:domain_verify" content="95b7d73b261f2e74c7f89dd4d2756856"/>
    ...
    <link rel="preload" as="image" href="https://punjabipalace.com.au/assets/img/banner/2025-02-18/W2.webp" type="image/webp">
	<!--====== Plugins CSS Files =======-->
			...
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					...
					<div class="sidebar-toggle-btn">
						<a class="nav-link nav_link_in" href="<?php echo base_url(); ?>cart" id="navbarDropdown3" style="display: none;">
				...
				<div class="row">
					...
					<div class="col-xl-6">
						<div class="footer-menu">
							<ul>
								<li><a href="<?php echo base_url(); ?>terms"><?php ##echo display('teams_of_use')?>Terms and Conditions</a></li>
