             ...
             <div class="panel-body">
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-12">
                         ...
                         <a  class="btn btn-success btn-sm search login_pa_cursors" onclick="logincustomer();"><?php echo display('login')?></a>&nbsp; <?php echo display('or')?> &nbsp;<a href="<?php echo base_url() . 'frontend/signup' ?>" class="btn btn-success btn-sm search"><?php echo display('register')?></a><?php $facrbooklogn = $this->db->where('directory', 'facebooklogin')->where('status', 1)->get('module')->num_rows(); if ($facrbooklogn == 1) { ?>
