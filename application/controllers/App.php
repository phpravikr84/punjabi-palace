...
class App extends MY_Controller
{
	...
	public function printinvoice()
	{
		...
		if (!empty($orderinfo)) {
			foreach ($orderinfo as $row) {
				...
				$output['orderinfo'][$o]['powerby'] = display('powerbyadzguru');
				$o++;
			}
			return $this->respondWithSuccess('Informations d\'impression.', $output);
		} else {
	...
	public function checkpurchasekey()
	{
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => 'https://store.adzguru.co/class.api.php?domain=' . $domain . '&product_key=' . $producrtkey . '&purchase_key=' . $purchasekey . '',
