...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2025 at 08:48 AM
...
(1125, 'Food List', 'Update Data', 'Food Updated', 'John Doe', '2025-05-26 22:29:42'),
(1126, 'Food List', 'Update Data', 'Food Updated', 'John Doe', '2025-05-26 22:29:56');
...
(1, 41, 'Chilli Pickle 1 Kg', 0.00, 0, 0, 0, 28, 2, 0, 1);
...
(168, 'E97E9SJT', '6', 'Waiter3', '', '', 'manik@gmail.com', '01913251229', NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 14, 0, NULL, 'Alabama', 'Dhaka', 143325, 1, 1, '2019-01-01', '2019-01-01', '2021-01-31', 'sdfs', 1, '2022-01-09', 1, 100, 1, '', 0, 0, '', '', '', '', '2019-01-09', 1, NULL, '0', '', '1970-01-01', 1, 'Bangladesh', 1, '', '', 'e4dfg', 1, 1, '', '', '34353636', '', '3636', '345345', '3453', '3453', '', '', '', ''),
...
(19, 'Biryani Masala shan 100gms', 2.75, 0.0275, 7, NULL, 3, 100.00, 1.0000, 950.00, 2.00, 0, 0, 1, 3),
...
(49, 'Ajwain 500 gms', 7.00, 0.0140, 7, NULL, 3, 500.00, 1.0000, 4550.00, 1.00, 0, 0, 1, 3),
...
(68, 'Rice 20KG', 45.00, 0.0023, 7, NULL, 3, 20.00, 1000.0000, 209750.00, 2.00, 0, 0, 1, 1),
...
(41, 'Chilli', '', 0, 0, '2025-05-02 10:16:23', '2025-05-23 15:54:33');
...
(53, 44, 27, 1, 2, 0, 1, '2025-05-22', '2025-05-22'),
(54, 44, 28, 1, 2, 0, 1, '2025-05-22', '2025-05-22'),
(57, 35, 31, 1, 2, 0, 1, '2025-05-20', '2025-05-20'),
(58, 35, 32, 1, 2, 0, 1, '2025-05-20', '2025-05-20'),
(59, 45, 33, 1, 2, 0, 0, '2025-05-22', '2025-05-22'),
(62, 50, 36, 1, 2, 0, 0, '2025-05-26', '2025-05-26'),
(64, 49, 38, 1, 2, 0, 0, '2025-05-23', '2025-05-23');
...
(29, 44, 27, 23, 250.00, 3, 'grm.', 6.25, 2, '2025-05-23'),
(30, 44, 27, 69, 100.00, 3, 'grm.', 0.22, 2, '2025-05-23'),
(31, 44, 28, 23, 500.00, 3, 'grm.', 12.50, 2, '2025-05-23'),
(32, 44, 28, 94, 250.00, 3, 'grm.', 5.50, 2, '2025-05-23'),
(35, 35, 31, 19, 50.00, 3, 'grm.', 1.38, 2, '2025-05-26'),
(36, 35, 31, 68, 250.00, 3, 'grm.', 0.55, 2, '2025-05-26'),
(37, 35, 32, 19, 100.00, 3, 'grm.', 2.75, 2, '2025-05-26'),
(38, 35, 32, 68, 350.00, 3, 'grm.', 0.77, 2, '2025-05-26'),
(39, 45, 33, 138, 1.00, 7, 'pcs', 15.00, 2, '2025-05-26'),
(42, 50, 36, 143, 250.00, 7, 'pcs', 30.00, 2, '2025-05-26'),
(44, 49, 38, 142, 500.00, 7, 'pcs', 10.00, 2, '2025-05-26');
...
(2, 'John', 'Doe', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum', '', 'admin@example.com', '827ccb0eea8a706c4c34a16891f84e7b', '', './assets/img/user/m2.png', '2025-05-26 16:23:35', '2025-05-22 20:45:53', '192.168.29.13', NULL, 1, 1),
...
(27, 44, 'Regular', 7.00, 7.00, 7.00, 7.00, 7.00, 6.47, 350.00),
(28, 44, 'Large', 20.00, 20.00, 20.00, 18.00, 19.00, 18.00, 750.00),
(31, 35, 'Regular', 2.00, 2.00, 3.00, 3.00, 3.00, 1.93, 300.00),
(32, 35, 'Large', 4.00, 4.00, 3.75, 4.00, 4.00, 3.52, 450.00),
(33, 45, 'Regular', 20.00, 20.00, 22.00, 22.00, 22.00, NULL, NULL),
(36, 50, 'Regular', 35.00, 35.00, 35.00, 35.00, 35.00, NULL, NULL),
(38, 49, 'Regular', 12.00, 12.00, 12.00, 12.00, 12.00, NULL, NULL);
...
--
ALTER TABLE `accesslog`
  MODIFY `sl_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1127;
...
--
ALTER TABLE `bill`
  MODIFY `bill_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `customer_order`
  MODIFY `order_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `item_foods`
  MODIFY `ProductsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `multipay_bill`
  MODIFY `multipay_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `order_menu`
  MODIFY `row_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `production`
  MODIFY `productionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `production_details`
--
ALTER TABLE `production_details`
  MODIFY `pro_detailsid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `purchase_details`
  MODIFY `detailsid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbl_kitchen_order`
  MODIFY `ktid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
